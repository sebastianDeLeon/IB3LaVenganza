...
namespace WebAppl.InternetBanking.Controllers
{
    ...
    public class ClientController : Controller
    {
        ...
        public async Task<IActionResult> ExpressPaidPost(ExpressPaid vm)
        {
            ...
            {
                vm.HasError = true;
                vm.Error = "Se ha producido un error al realizar el pago! .";
                return View(vm);
            }
            ...
            if (!value)
            {
                ...
                vm.HasError = true;
                vm.Error = "Ha ocurrido un error intentando hacer el pago expreso, por favor comunicarse al soporte tecnico.";
                return View(vm);
            }
